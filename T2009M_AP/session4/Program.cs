...
{
    public delegate void ShowString(string s); // khai bao 1 delegate dai dien cho cac ham return void va tham so: string 
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
                       ...
                       ss += new DemoDelegate().ShowInfo; // nap them ham vao danh sach thuc hien
